...
| 이름 | 함수이름 | 사용법 |
|:---:|:---:|:---:|
| Vector | `c()` | <span style="color:skyblue">Numeric : c(1, 2, 3, 4)<br>Char : c("가", "나", "다", "라") |
| List | `list()` | <span style="color:skyblue">list(c(1, 2, 3, 4), c('a', 'b', 'c')) |
| List->Vector | `unlist()` | <span style="color:skyblue">unlist(리스트변수) |
| Matrix | `matrix()` | <span style="color:skyblue">matrix(vector, nrow = [정수 값]) |
| Structure | `str()` | <span style="color:skyblue">str(조회 하고자 하는 변수) |
