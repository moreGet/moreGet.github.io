...
layout: post
title: R-Studio 군집분류
subtitle: R-Studio의 hclust, dist, cutree, kmeans, cor 이용
...
<a href="../assets/sources/S20191112.zip" class="btn btn-lg btn-outline">
S20191112.zip
</a>
<br>
<br>
...
> cutree 계층형 군집 분석 결과에서 분석자가 원하는 군집의 개수 만큼 잘라서 인위적으로 군집을 만들 수 있다.( ststs 패키지) cuttree() 함수는 군집 수만큼 그룹을 지어 잘라 내어 주는 함수이다.<br>
> kmeans 군집 분류를 위하여 사용하는 함수는 stats 패키지의 kmeans() 함수를 사용하면 된다. <br>
> cor 상관 계수 보기 <br>
